...
public class AlesatoreRameTest {
    ...
    public void usaEffettoCarta_test1() throws MossaIllegaleException, RemoteException {
        ...
        CartaUtensile carta1 = FactoryCartaUtensile.getCartaUtensile(3);
        ...
        ((AlesatoreRame) carta1).setxDie(1);
        ((AlesatoreRame) carta1).setyDie(0);

        ((AlesatoreRame) carta1).setxCell(3);
        ((AlesatoreRame) carta1).setyCell(0);
        ...
        assertTrue(PartitaCorrente.getCurrentPlayer().getPlancia().leggiPlancia(3,0).getNumero() == 2);
        assertTrue(PartitaCorrente.getCurrentPlayer().getPlancia().leggiPlancia(3,0).getColore().equals("Viola"));
    ...
    public void usaEffettoCarta_test2() throws MossaIllegaleException, RemoteException {
        ...
        ((AlesatoreRame) carta1).setxCell(2);
        ((AlesatoreRame) carta1).setyCell(1);
        PartitaCorrente.getAzioniGiocatore().add(1);
        ...
        assertTrue(PartitaCorrente.getCurrentPlayer().getPlancia().leggiPlancia(2,1) == null);
    ...
    public void usaEffettoCarta_test3() throws MossaIllegaleException, RemoteException {
        ...
        ((AlesatoreRame) carta1).setxDie(3);
        ((AlesatoreRame) carta1).setyDie(3);
        ...
        //aggiunti per avere una copertura del 100%
