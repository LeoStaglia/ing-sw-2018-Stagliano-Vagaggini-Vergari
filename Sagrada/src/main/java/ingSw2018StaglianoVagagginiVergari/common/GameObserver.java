...
public interface GameObserver extends Remote {
    ...
    public void updateView(HashMap< String,String[][]> planceGiocatori , LinkedHashMap<String,String> listaCartaUtensile, String giocatoreCorrente, int turno, int round, ArrayList<String > dadiRiserva, String dadoSelezionato, ArrayList<String> carteObiettivoPubblico, HashMap<String,String> obiettiviPrivati) throws RemoteException;
